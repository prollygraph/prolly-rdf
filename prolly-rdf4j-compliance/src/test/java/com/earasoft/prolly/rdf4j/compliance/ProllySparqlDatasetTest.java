...
/**
 * FROM / FROM NAMED dataset scoping against a live repository — the dataset surface the manifest
 * suites only touch via manifests.
 *
 ...
 */
public class ProllySparqlDatasetTest
        extends org.eclipse.rdf4j.testsuite.repository.SparqlDatasetTest {
