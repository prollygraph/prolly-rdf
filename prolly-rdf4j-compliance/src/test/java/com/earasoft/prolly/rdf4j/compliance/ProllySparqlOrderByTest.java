...
/**
 * ORDER BY value-ordering semantics — collation over the term-faithful codec.
 *
 ...
 */
public class ProllySparqlOrderByTest
        extends org.eclipse.rdf4j.testsuite.repository.SparqlOrderByTest {
