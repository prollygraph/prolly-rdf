...
/**
 * W3C SPARQL 1.0 (DAWG) query evaluation — the predecessor suite the 1.1 wiring never covered; the
 * same ratchet discipline.
 *
 ...
 */
public class ProllySparql10QueryComplianceTest
        extends org.eclipse.rdf4j.testsuite.query.parser.sparql.manifest
                .SPARQL10QueryComplianceTest {

    {
        KnownFailures.load("/known-failures/sparql10-query.txt").forEach(this::addIgnoredTest);
    }
