...
/**
 * SELECT TupleQueryResult contract (binding names, streaming, close).
 *
 ...
 */
public class ProllyTupleQueryResultTest
        extends org.eclipse.rdf4j.testsuite.repository.TupleQueryResultTest {
